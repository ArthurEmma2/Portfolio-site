    ...
    <div className='container'>
      ...
      <div className="shadow-lg rounded-lg bg-[#FFEFF6]">  
        ...
        <div className='pb-5 w-full px-5'data-aos='flip-up'>
          ...
          Star Trade is an NFT marketplace with high quality user friendly interface. Built with Taquito js, React js and bootstrap.     

          </p>
          <div className="flex flex-col xl:flex-row justify-between pb-[33px] gap-[20px]" >
            <a className='bg-btnColor p-[9px] rounded-xl text-center text-white hover:bg-[#FFEFF6] hover:text-black border-btnColor border-2'target="_blank" rel="noreferrer" href="https://starnftmarketplace.netlify.app/">
              View Site
            </a>
            <a className='border-btnColor border-2 rounded-xl p-[9px] text-black text-center hover:bg-btnColor hover:text-white'target="_blank" rel="noreferrer" href="https://github.com/yhawNoworries/Star-NFT">
              Source code
            </a>
          </div>
        </div>
        <div className='flex gap-x-2 mx-auto items-center ml-4 mb-[2px]'>
          <div>
           <img className='w-[23px]' src={REACT}  alt='icon' />
          </div>
          <div>
           <img className='w-[25px]' src={BOOSTRAP}  alt='icon' />
          </div>
        </div>
