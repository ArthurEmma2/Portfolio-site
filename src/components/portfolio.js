  ...
  return (
    ...
    <div className='flex'>
      ...
      <div className="shadow-lg rounded-lg bg-[#FFEFF6]">  
          <img src={img4} alt='products' className="rounded-tl-lg rounded-tr-lg object-cover " />
        <div className='pb-5 w-full px-5'data-aos='flip-up'>
          <h3 className='sm:text-center pb-[24px] pt-[31px] text-xl font-bold md:text-center text-btnColor'>Star Trade</h3>
          <p className='font-normal text-black pb-8 text-[14px]'>
          Star Trade is an NFT marketplace built over Tezos with high-quality user-friendly interface. Built with Taquito js, React js and bootstrap.     

          </p>
          <div className="flex flex-col xl:flex-row justify-around pb-[33px] gap-[10px]" >
            <a className='bg-btnColor w-full h-full  lg:h-[45px] lg:w-[140px] rounded-xl text-center text-white hover:bg-[#FFEFF6] hover:text-black border-btnColor border-2'target="_blank" rel="noreferrer" href="https://starnftmarketplace.netlify.app/">
            <p className='text-center mt-auto lg:mt-[9px]'> View Site</p>
            </a>
            <a className='border-btnColor border-2 rounded-xl w-full h-full lg:h-[45px] lg:w-[140px] text-black text-center hover:bg-btnColor hover:text-white'target="_blank" rel="noreferrer" href="https://github.com/yhawNoworries/Star-NFT">
      ...
      <div className="shadow-xl rounded-lg bg-[#FFEFF6]">
          <img src={img3} alt='products' className="rounded-tl-lg rounded-tr-lg object-cover slider_img" />
        <div className='pb-5 w-full px-5' data-aos='flip-up'>
          <h3 className='sm:text-center pb-[24px] pt-[31px] text-xl font-bold md:text-center text-btnColor'>Aptos More</h3>
          ...
          <a className='bg-btnColor w-full h-[32px]  lg:h-[45px] lg:w-[140px] rounded-xl text-center text-white hover:bg-[#FFEFF6] hover:text-black border-btnColor border-2'target="_blank" rel="noreferrer" href="https://aptosmore.netlify.app/">
          <p className='text-center mt-auto lg:mt-[9px]'> View Site</p>
            </a>
            <a className='border-btnColor border-2 rounded-xl w-full h-[32px] lg:h-[45px] lg:w-[140px] mt-3 lg:mt-0  text-black text-center hover:bg-btnColor hover:text-white'target="_blank" rel="noreferrer" href="https://github.com/ArthurEmma2/Aptos-More">
            <p className='text-center mt-auto lg:mt-[9px] '>  Source code</p>
            </a>
          </div>
        </div>
